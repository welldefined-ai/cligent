"""Base classes for simplifying provider-specific implementations."""
...
from .models import Message, Chat, Role, LogStore
...
class BaseStore(LogStore):
    ...
    def __init__(self, config: ProviderConfig):
        ...
        super().__init__(config.name, str(Path.cwd()))
